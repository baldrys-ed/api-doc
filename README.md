...
setfacl -dR -m u:"$HTTPDUSER":rwX -m u:app:rwX /home/app/stefa/backend/var \
/home/app/stefa/backend/public/media /home/app/stefa/backend/public/uploads

setfacl -R -m u:"$HTTPDUSER":rwX -m u:app:rwX /home/app/stefa/backend/var \
/home/app/stefa/backend/public/media /home/app/stefa/backend/public/uploads
```
...
## FFmpeg Setup
Install FFmpeg and FFprobe on your system. For Ubuntu/Debian:
```bash
sudo apt update
...
```bash
git init
git remote add origin git@github.com:aliensource-org/stefa-backend.git
git fetch origin
